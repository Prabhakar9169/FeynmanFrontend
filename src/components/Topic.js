...
const Submit = () =>{
    if(data.title  === "" && data.description === "") return alert("fill details")
    ...
    <div  className='user2'>
       ...
       <h1>ADD TOPIC</h1>
        ...
        <div className='Topic'>
          <div className='title'>
           <label>Topic : </label>
           <input type="text" name="title" placeholder ="Enter Topic" onChange={handleChange}/>
          </div>
        ...
        <button type="submit" className=" btn2 " onClick={Submit}>Check</button>
        ...
        <Modal.Body>
          ...
          <div className='change'>
            {list.map((item , ind)=>
                     <label key={ind}>
                    <span className='span'style={{color: state === ind ? color : "black"}} onClick={()=>{setState(ind , open())}}>{item},</span>
                    </label>
            )}
...
<div className='button1'>
        <button type="submit"  name="green" style={{backgroundColor:"green"}} onClick={changeColor}>Understood</button>
        <button type="submit"  name="yellow" style={{backgroundColor:"yellow"}} onClick={changeColor} >Somewhat Understood</button>
        <button type="submit"  name="blue" style={{backgroundColor:"lightblue"}} onClick={changeColor}>Not Clear</button>
        <button type="submit"   name="red" style={{backgroundColor:"red"}} onClick={changeColor}>What Rubbish</button>
 </div>
